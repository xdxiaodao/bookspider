package com.github.xdxiaodao.spider.core.base.service.webmagic;
...
@Service
@ThreadSafe
public class SafelyHttpDownloader extends AbstractDownloader {
    ...
    protected void onError(Request request) {
        ...
        Object obj = request.getExtra(Request.PROXY);
        if (obj instanceof HttpHost) {
            HttpHost httpHost = (HttpHost) obj;
            HttpProxyUtil.removeHttpProxy(httpHost);
        }
    }
}
